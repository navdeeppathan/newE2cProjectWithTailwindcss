    ...
    <div>
      ...
      <div className="flex flex-col items-center py-20">
        <div className="w-96 md:w-[584px] xl:w-[862px] min-h-80 overflow-y-auto">
          <div className="flex flex-col md:flex-row md:flex-wrap  xl:flex-wrap xl:flex-row gap-x-2 gap-y-4 p-4 items-center justify-center">
            {Fields.map((title) => {
              return (
                <div
                  key={title.id}
                  className={`cursor-pointer border rounded py-2 px-4 min-w-30 max-w-[calc(100%-1rem)] flex items-center justify-center ${
                    onPress === title.id
